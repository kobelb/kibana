...
import { IESQueryIndexPattern, IESQueryIndexPatternField } from '../index_pattern';
...
const formatValue = (field: IESQueryIndexPatternField, params: any[]) =>
  map(params, (val: any, key: string) => get(operators, key) + format(field, val)).join(' ');

const format = (field: IESQueryIndexPatternField, value: any) =>
...
export const buildRangeFilter = (
  field: IESQueryIndexPatternField,
  params: RangeFilterParams,
  indexPattern: IESQueryIndexPattern,
  formattedValue?: string
): RangeFilter => {
...
export const getRangeScript = (field: IESQueryIndexPatternField, params: RangeFilterParams) => {
