...
export const getPhraseScript = (field: IESQueryIndexPatternField, value: string) => {
  const convertedValue = getConvertedValueForField(field, value);
...
export const getConvertedValueForField = (field: IESQueryIndexPatternField, value: any) => {
