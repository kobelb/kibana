...
import { KueryNode } from '../index';
import { SerializableRecord } from '../../../../../core/types';
import { IESQueryIndexPattern } from '../../index_pattern';
...
interface NamedArgType {
  ...
  toElasticsearchQuery: (node: any) => SerializableRecord;
}
