...
export function toElasticsearchQuery(
  ...
  const fieldList: IESQueryIndexPatternField[] = indexPattern?.fields ?? [];
  const field = fieldList.find((fld: IESQueryIndexPatternField) => fld.name === fieldName);
  const queryParams = {
