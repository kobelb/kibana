...
describe('server config transformDeprecations', function () {
  it('sets server.ssl.enabled to true when certificate and key are set', function () {
    const settings = {
      server: {
        ssl: {
  ...
  it(`doesn't set server.ssl.enabled when key and cert aren't set`, function () {
    const settings = {
      server: {
        ssl: {}
      }
